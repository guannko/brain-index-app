      ...
      <section className="pt-20 pb-32 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/demo"
              className="bg-white text-gray-900 px-8 py-4 rounded-lg text-lg font-semibold border border-gray-300 hover:bg-gray-50 transition"
            >
              Watch Demo
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Multi-AI Analysis</h3>
              <p className="text-gray-600">
                Track your visibility across ChatGPT, Claude, Gemini, and more
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get instant alerts when AI systems update their knowledge
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get specific recommendations to improve your AI visibility
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of brands improving their AI visibility
          </p>
          <Link
            href="/register"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm">
                The leading platform for AI visibility analytics
              </p>
            </div>
            <div>
